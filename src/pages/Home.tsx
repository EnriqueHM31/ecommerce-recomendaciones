                    ...
                    <div className="max-w-11/12 mx-auto  grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative ">
                        ...
                        >
                            <motion.h1
                                ...
                                className="text-5xl lg:text-6xl text-theme-primary mb-4 leading-tight font-bold"
                            >
                            ...
                            <motion.p
                                ...
                                className="text-lg text-theme-primary mb-8 leading-relaxed"
                            >
                            ...
                            <motion.button
                                ...
                                className="bg-theme-primary text-theme-secondary px-6 py-3 text-2xl font-semibold cursor-pointer rounded-2xl hover:bg-white hover:text-theme-primary transition-colors duration-300 ease-in-out"
                            >
                                Ver Productos
                            </motion.button>
                        </motion.div>
